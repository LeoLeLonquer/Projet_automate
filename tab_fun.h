...
struct Fun {
	char id[16];
	int ground; //permet de restaurer le ground de tab_symb précédant
	int nbArg;
} ;
...
int get_ground_fun(int indice); //renvoie l'adresse de début de la fonction en fonction de son indice dans le tableau
